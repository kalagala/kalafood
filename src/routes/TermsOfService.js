...
import AppBarLogoOnly from "../containers/AppBarLogoOnly";
...
const TermsOfService = () => {
  return (
    <div>
      <AppBarLogoOnly />
      <div className="terms">
        <h2>Welcome to kalafood</h2>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of kalafood's Website.
        </p>{" "}
        <br />
        <span> KALAFOOD</span> is located at:
        <br />
        <address>
          Mzumbe University Morogoro, <br />
          Tanzania
          <br />
        </address>
        <p>
          By accessing this website we assume you accept these terms and
          conditions in full. Do not continue to use kalafood's website if you
        ...
        <p>
          ...
          accordance with and subject to, prevailing law of Tanzania. Any use of
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using kalafood's website you consent
          to the use of cookies in accordance with kalafood's privacy policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, kalafood and/or it's licensors own the
          intellectual property rights for all material on kalafood. All
          intellectual property rights are reserved. You may view and/or print
          pages from https://kalafood.net for your own personal use subject to
          restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from https://kalafood.net</li>
          <li>Sell, rent or sub-license material from https://kalafood.net</li>
          <li>
            Reproduce, duplicate or copy material from https://kalafood.net
          </li>
        </ol>
        <p>
          Redistribute content from kalafood (unless content is specifically
        ...
        <p>
          ...
          outweighs the absence of kalafood; and (d) where the link is in the
        ...
        <p>
          ...
          e-mail to{" "}
          <a
            href="mailto:kalagalakapunda@gmail.com"
            title="send an email to kalagalakapunda@gmail.com"
          >
            kalagalakapunda@gmail.com
          </a>
        ...
        <p>
          No use of kalafood's logo or other artwork will be allowed for linking
